...
export async function generatePdf(url: string, report: AuditReport) {
  ...
  // Set a large viewport to ensure screenshots are captured well
  ...
  const htmlContent = `
    ...
    <head>
      ...
      <style>
        ...
        .impact-text { font-size: 13px; font-weight: 700; color: #fff; font-style: italic; }
        ...
        .cta-headline { font-family: 'Bebas Neue', cursive; font-size: 60px; line-height: 0.9; margin-bottom: 20px; }
    ...
    <body>
      <div class="page">
        ...
        <div class="summary-card border-red">
          ...
          <p style="font-size: 16px; font-weight: 700; margin: 15px 0 0 0;">${report.executive_summary}</p>
        </div>
      ...
      <div class="page" style="padding-top: 20px;">
            ...
            <div class="issue-body">
              ...
              <div>
                <div class="point impact-callout">
                  ...
                  <div style="font-size: 10px; color: #D0202E; font-weight: 900; margin-top: 8px; text-transform: uppercase;">Potential Reclaimed: ${issue.opportunity}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="cta-box">
          ...
          <div style="font-size: 16px; font-weight: 700;">${report.growth_potential_cta}</div>
